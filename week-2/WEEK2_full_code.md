# Nädal 2 — Kogu Kood (Individuaalne + Meeskond)

## 1. Individuaalne kood — DACA (`WEEK2_data_cleaning.sql`)
...
Nädal 2 kohta puudub minu isiklikule nimele atribueeritud eraldi meeskonnakood — [TEAMWORK.md](./TEAMWORK.md)-s on see nädal märgitud kui "kinnitamisel", kuna ma ei leidnud meeskonna failidest üheselt minu nimega seotud koodi selle nädala kohta. Vaata [Data_Landscape_Week2.pdf](https://github.com/kaarusdoris-a11y/Sales-Analytics/blob/main/Data_Landscape_Week2.pdf) meeskonna üldise leiu jaoks.
