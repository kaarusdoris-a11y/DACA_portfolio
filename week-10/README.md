# Nädal 10 — Portfoolio Kaitsmine

**Programm:** DACA — Andmeanalüütiku Karjäärikiirendi
**Nädal:** 10 — Portfoolio Kaitsmine (Grupitöö, Lõpuesitlus)
**Kontekst:** UrbanStyle.ltd juhatuse koosolek — meeskonna 7-minutiline lõpuesitlus 10 nädala andmetööst
...
Lõpuesitluse slaidid, andmed ja meeskonna ühine README asuvad meie grupiprojektis: [Sales-Analytics](https://github.com/kaarusdoris-a11y/Sales-Analytics). Minu rolli ja panuse kokkuvõte kogu programmi jooksul: [TEAMWORK.md](../TEAMWORK.md).
...
The final presentation slides, data, and the team's shared README live in our group project: [Sales-Analytics](https://github.com/kaarusdoris-a11y/Sales-Analytics). Summary of my role and contribution across the whole programme: [TEAMWORK.md](../TEAMWORK.md).

---
*DACA26 · Nädal 10 · UrbanStyle.ltd andmeanalüüs*
