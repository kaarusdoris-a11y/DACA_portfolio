# Nädal 6 — Kogu Kood (Individuaalne + Meeskond)

## 1. Individuaalne kood — DACA (`WEEK6_storytelling.py`)
...
Nädal 6 kohta puudub minu isiklikule nimele atribueeritud eraldi meeskonnakood — [TEAMWORK.md](./TEAMWORK.md)-s on see nädal märgitud kui "kinnitamisel" (Henri Greenbaum lahkus meeskonnast pärast nädalat 6, mis raskendab selle nädala rollide tagantjärele kinnitamist). Vaata [Data_Landscape_Week6.pdf](https://github.com/kaarusdoris-a11y/Sales-Analytics/blob/main/Data_Landscape_Week6.pdf) meeskonna üldiste visualiseerimisandmete jaoks.
